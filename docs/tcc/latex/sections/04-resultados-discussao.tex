...
Esta seção usa o arquivo agregado disponível em \path{docs/benchmark/results-aggregated.csv}. Os valores são médias de três repetições; o desvio padrão deve ser consultado no mesmo arquivo. A tabela não substitui a auditoria dos dados brutos em \path{docs/benchmark/results.csv}.
