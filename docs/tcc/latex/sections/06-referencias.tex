...
\bibitem{project}
PROJETO TCC. \textit{Plataforma de streaming e benchmark RTMP}. Repositório local do projeto, 2026. Dados em \texttt{docs/benchmark/results.csv} e \texttt{docs/benchmark/results-aggregated.csv}.
